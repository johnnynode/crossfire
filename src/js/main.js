...
/*         合作媒体  小轮播图           */
var speed1=3000; var $i=0;var speed1_1=200;
...
/*          评论的滚动字幕           */
var speed2=3000;var $dis_count=0;var speed2_2=300;
...
/*       最大轮播图        */
/*  定时器的设置  */
var speed3=1000;var $rc_index=0;
...
function fun3(){
	...
	if($pic_index>($pic_l-1)){
		$pic_index=1;
		$('.real_pic_list').css({'top':0});
	}
	$('.real_pic_list').stop().animate({'top':-$pic_index*$pic_h+'px'},speed3_3);
...
$('.rectangle_click li').hover(function(){
	...
	$('.real_pic_list').stop().animate({'top':(-$this_rc_index*$pic_h)+'px'},speed3_3);
